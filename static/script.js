document.addEventListener('DOMContentLoaded', async () => {
    ...
    const translateButtonMappings = {
        'translate-chatgpt-prompt': promptChatGPTInput,
        'translate-nanobanana-prompt': promptNanoBananaInput,
        'translate-modelscope-positive': promptPositiveInput,
        'translate-modelscope-negative': promptNegativeInput
    };
    ...
    function showTranslateMessage(message, type = 'info') {
        ...
        messageEl.className = 'translate-message';
        ...
        switch (type) {
            case 'success':
                messageEl.style.backgroundColor = 'var(--gradient-mid)';
            ...
            case 'error':
                ...
                break;
            default:
                messageEl.style.backgroundColor = 'var(--surface-color)';
                messageEl.style.color = 'var(--text-color-primary)';
